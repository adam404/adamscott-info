  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <main className="relative isolate">
        {/* Background */}
        <div
          className="fixed inset-x-0 top-4 -z-10 flex transform-gpu justify-center overflow-hidden blur-3xl animate-float"
          aria-hidden="true"
        >
          <div
            className="aspect-[1108/632] w-[69.25rem] flex-none bg-gradient-to-r from-blue-800 via-blue-600 to-blue-300 opacity-25 animate-gradient-shift"
            style={{
              clipPath:
