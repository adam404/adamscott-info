    ...
    <footer className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
      <div className="flex justify-center space-x-6 md:order-2">
        <Link
          ...
          className={`${dark ? "text-gray-400 hover:text-white" : "text-muted-foreground hover:text-foreground"}`}
        >
      ...
      <div className="mt-8 md:order-1 md:mt-0">
        <p
          className={`text-center text-xs leading-5 ${dark ? "text-gray-400" : "text-muted-foreground"}`}
        >
          &copy; {new Date().getFullYear()} Adam Scott. All rights reserved.
        </p>
      </div>
    </footer>
  );
